...
const SAVING_DIR = FORMAL ? SAVING_DIR_HOME + '/formal_' + SAVING_FOLDER_NAME : SAVING_DIR_HOME+'/testing_' + SAVING_FOLDER_NAME;
...
instr_text[2] = "This experiment will take about 30 minutes to complete.<br /><br />Please help us by reading the instructions in the next few pages carefully, and avoid using the refresh or back buttons.";
...
instr_text[5] = "You will complete two short experiments.<br /><br />In the first experiment, we will show you some simple animations of two triangles interacting with each other, just like the one in the example below.";
instr_text[6] = "This experiment contains 27 trials. In each trial, a video will show up, and you will click on the video to play.";
instr_text[7] = "After you watch the video, some labels will show up. Your job is to select ONE label that best describes the interaction in the video.";
instr_text[8] = "You may click on the video to replay it as many times as you like.";
instr_text[9] = "Let's try it once on the next page!";
instr_text[10] = "";
instr_text[11] = "I hope that was clear!<br /><br />By the way, you don't need to spend too much time thinking about what to choose. Just follow your intuition.";
instr_text[12] = "One last thing: Please make sure you choose based on the content of the animations, not the length or duration of them."
instr_text[13] = "The next page is a quick instruction quiz. (It's very simple!)";
instr_text[14] = "";
instr_text[15] = "Great! You can press SPACE to start. Please focus after you start. (Don't switch to other windows or tabs!)";
